/******************************************************
#1 add two methods for planner capability
	content: getASList();getAAList()
	author : yangshuo
	time   : 2016-8-14
...
public class Capability implements Serializable {
	...
	public Capability(String id, BeliefBase beliefBase, PlanLibrary planLibrary) {
		if (id == null) {
			if (this.getClass().getCanonicalName() == null || Capability.class.equals(this.getClass())) {
				this.id = Capability.class.getSimpleName() + System.currentTimeMillis();
			} else {
	...
	/**
	 * get AIDs of all actuator agents
	 */
